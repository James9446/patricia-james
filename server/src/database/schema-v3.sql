-- ========================================
-- Patricia & James Wedding Database Schema v3
-- Refined for Name-based Authentication and Dynamic Plus-Ones
-- ========================================
...
CREATE TABLE IF NOT EXISTS guests (
    ...
    is_primary_guest BOOLEAN DEFAULT true, -- True for main guest, false for partner/plus-one
...
CREATE TABLE IF NOT EXISTS users (
    ...
    username VARCHAR(50) UNIQUE NOT NULL, -- Will be full_name for simplicity
...
INSERT INTO guests (first_name, last_name, is_primary_guest, plus_one_allowed, admin_notes) VALUES
('Cordelia', 'Reynolds', true, false, 'Individual guest, no plus-one'),
('Tara', 'Folenta', true, false, 'Partner of Brenda Bedell'),
('Brenda', 'Bedell', true, false, 'Partner of Tara Folenta'),
('Alfredo', 'Lopez', true, true, 'Individual guest, plus-one allowed')
...
-- Mark Brenda as not primary (since Tara is the primary guest in this couple)
UPDATE guests 
